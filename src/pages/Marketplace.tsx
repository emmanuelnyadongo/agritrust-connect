  ...
  return (
    <AppLayout>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/50">
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-muted-foreground">Available</th>
              ...
              >
                ...
                <td className="px-4 py-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {listing.farmer.transactions} trades · {listing.farmer.rating}★
                  </p>
                </td>
                ...
                <td className="px-4 py-3 text-right text-muted-foreground">
                  ${listing.marketLow.toFixed(2)}–${listing.marketHigh.toFixed(2)}
                </td>
      ...
      <p className="mt-4 text-xs text-muted-foreground">
        Prices are per kilogram in USD. Market ranges are based on the last 30 days of confirmed transactions across all regions.
      </p>
    </AppLayout>
  );
};
