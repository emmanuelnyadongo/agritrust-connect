          ...
          <section>
            ...
            <dl className="space-y-2 text-sm">
              {[
                ...
                ['Available', `${listing.availableFrom} → ${listing.availableUntil}`],
              ].map(([label, value]) => (
          ...
          <section>
            ...
            <div className="rounded border border-border p-4">
              <div className="mb-3 flex flex-col gap-1 text-sm sm:flex-row sm:items-baseline sm:justify-between">
                ...
                <span className="font-medium text-foreground">${listing.marketLow.toFixed(2)} — ${listing.marketHigh.toFixed(2)} / kg</span>
              </div>
              <div className="relative h-2 rounded-full bg-muted">
                <div className="absolute top-0 h-2 w-full rounded-full bg-primary/20" />
                <div className="absolute top-0 h-2 w-0.5 bg-primary/40" style={{ left: `${((listing.marketMedian - listing.marketLow) / (listing.marketHigh - listing.marketLow)) * 100}%` }} />
